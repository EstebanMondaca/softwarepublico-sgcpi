...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<tr>
		<div class="row">
		<td><?php echo $form->labelEx($model,'tipo_cliente_id',array('class'=>'blockLabel')); ?></td>
		<td><?php echo $form->dropDownList($model, 'tipo_cliente_id', GxHtml::listDataEx(TiposClientes::model()->findAll(array('condition'=>'estado=1'))));?></td>
		<td><?php echo $form->error($model,'tipo_cliente_id'); ?></td>
		</div><!-- row -->
		</tr>
		<tr>
		<div class="row">
