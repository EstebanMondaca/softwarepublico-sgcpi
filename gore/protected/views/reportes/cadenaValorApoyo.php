...
<table class="cadenaValor" width="100%" border="0" cellspacing="5" cellpadding="5">
  ...
  <tr>
    <th style="vertical-align: middle;background-color: #F4F4F4;" width="10%" class="borde">CLIENTES</th>
  ...
  <tr>
    <th style="vertical-align: middle;background-color: #F4F4F4;" class="borde">SUBPROCESOS</th>
    <?php
        foreach($model as $key=>$value){
            $colorFondo='#FFF';
            $colorLetra='#000';
            ...
            echo '<td style="color:'.$colorLetra.';background-color:'.$colorFondo.'" valign="top" class="borde">';
                echo '<ul>';
  ...
  <tr>
    <td>&nbsp;</td>    
        <?php
        foreach($model as $value){
            echo '<td style="text-align:center;" class="borde">'.$value->division.'</td>';
        }
        ?>
  </tr>-->
</table>