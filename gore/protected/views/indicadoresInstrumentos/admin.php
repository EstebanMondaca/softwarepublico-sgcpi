...
Yii::app()->clientScript->registerScript('restrictCbSelection','
    $(document).ready(function(){
        ...
        $(".check_FH:checked").each(function(){
        	$(this).parent().children("input[type=\'text\']").removeAttr("disabled").show();
        });
        
        $(".check_CDC:checked").each(function(){
        	$(this).parent().children("input[type=\'text\']").removeAttr("disabled").show();
        });    

        $(".check_T:checked").each(function(){
        	$(this).parent().children("input[type=\'text\']").removeAttr("disabled").show();
        });
        
        resumenIndicadoresAsignadosInstrumentos();
        
        $("#indicadores-instrumentos-form").submit(function(e) {
        	e.preventDefault();
        	var form = this;
        	var mensaje= resumenIndicadoresAsignadosInstrumentos("btnGuardar");
        	
			jConfirm(mensaje, "Confirmación de datos", function(r) {
        		if(r){
