	...
	<div class="fieldset2">
				...
				<div class="content"> 
					...
					<div style="float:left;width:750px;">
						<div id="conceptoa" >
						<b>Valor A:</b> <input name="avance[valorA]" id="valorA" maxlength="2" readonly="readonly" onblur="<?php echo "calcularFormulaRegistroAvances(".$tipo_resultado_formula.','.$meta_anual.");";?>" onkeydown="validarNumeros(event);" type="text"  style="/*display:none;*/" value="<?php echo $modelHitos->conceptoa;?>" maxlength="9" size="10">
						&nbsp;&nbsp; <?php echo " Meta: ".$modelindicadores->conceptoa; ?>
						<br>
						</div>
						<div id="conceptob" >
						<b>Valor B:</b> <input name="avance[valorB]" id="valorB" maxlength="2" readonly="readonly" onblur="<?php echo "calcularFormulaRegistroAvances(".$tipo_resultado_formula.','.$meta_anual.");";?>" onkeydown="validarNumeros(event);" type="text" value="<?php echo $modelHitos->conceptob;?>" maxlength="9" size="10">
						&nbsp;&nbsp; <?php echo " Meta: ".$modelindicadores->conceptob; ?>
						<br>
						</div>
						<div id="conceptoc" >
						<b>Valor C:</b> <input name="avance[valorC]" id="valorC" maxlength="2" readonly="readonly" onblur="<?php echo "calcularFormulaRegistroAvances(".$tipo_resultado_formula.','.$meta_anual.");";?>" onkeydown="validarNumeros(event);" type="text"  value="<?php echo $modelHitos->conceptoc;?>" maxlength="9" size="10">
