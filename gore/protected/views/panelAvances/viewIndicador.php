		...
		foreach($meses as $key => $m)
		{
			...
			if (isset($real)){
				...
				if ($permiteIngresarAvance){
					echo '<td class="centrarTexto"><a class="update"  href="'.Yii::app()->request->baseUrl.'/panelAvances/registroavance/'.$idHito.'?nombre_i='.urlencode($nombreIndicador).'&nombre_productoEst='.urlencode($nombreProductoEstrategico).'&nombre_productoEsp='.urlencode($nombreProductoEspecifico).'&nombre_sub='.urlencode($nombreSubproducto).'">'.$real.'%</a></td>';	
				}else{
					echo '<td class="centrarTexto"><a class="update"  href="'.Yii::app()->request->baseUrl.'/panelAvances/registroavanceView/'.$idHito.'?nombre_i='.urlencode($nombreIndicador).'&nombre_productoEst='.urlencode($nombreProductoEstrategico).'&nombre_productoEsp='.urlencode($nombreProductoEspecifico).'&nombre_sub='.urlencode($nombreSubproducto).'">'.$real.'%</a></td>';	
				}
			}else{
				if (isset($parcial)){
					if ($permiteIngresarAvance){
						echo '<td class="centrarTexto"><a class="update" href="'.Yii::app()->request->baseUrl.'/panelAvances/registroavance/'.$idHito.'?nombre_i='.urlencode($nombreIndicador).'&nombre_productoEst='.urlencode($nombreProductoEstrategico).'&nombre_productoEsp='.urlencode($nombreProductoEspecifico).'&nombre_sub='.urlencode($nombreSubproducto).'">Reg</a></td>';	
					}else{
						echo '<td class="centrarTexto"><a class="update" href="'.Yii::app()->request->baseUrl.'/panelAvances/registroavanceView/'.$idHito.'?nombre_i='.urlencode($nombreIndicador).'&nombre_productoEst='.urlencode($nombreProductoEstrategico).'&nombre_productoEsp='.urlencode($nombreProductoEspecifico).'&nombre_sub='.urlencode($nombreSubproducto).'">Reg</a></td>';	
					}
				}else {
					echo '<td class="centrarTexto">-</td>';
				}
				...
				if ($permiteIngresarAvance){
					echo '<td class="centrarTexto">'.$real.'%</td>';	
				}else{
					echo '<td class="centrarTexto">'.$real.'%</td>';	
				}
			}else{
...
<br />
<p>
<input id="botonComentario" class="update"  type="button" value="Observaciones" href="<?php  echo Yii::app()->request->baseUrl.'/panelAvances/verComentarios?id_indicador='.$id ?>">
</p>
