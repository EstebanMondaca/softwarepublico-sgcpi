	   ...
	   array('header'=>'N°',
        ...
        array(
         ...
         array(
            ...
            'value'=>'$data->estadoUltimoPuntajeRevisado'
         ), 
		array(
			'class' => 'CButtonColumn',
			...
			'buttons'=>array(
			             'update'=>	array(
							     ...
							     'visible'=>'(Yii::app()->user->checkAccess("supervisor")) && (Yii::app()->user->checkAccessByCierre("EvaluacionElementosGestionController")) && (Yii::app()->user->checkAccessChangeByCentroCostoFromElementosGestion(array("modelName"=>"ElementosGestion","idRow"=>$data->id)))',
                                 ),	
                         'view'=>
                            array(    
